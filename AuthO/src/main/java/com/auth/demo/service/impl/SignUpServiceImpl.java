...
public class SignUpServiceImpl implements SignUpService {
	...
	@Override
	public OnboardResponse signUpUser(@Valid OnboardUserRequest userRequest) throws RuntimeException {
		...
		userRole.setRoleId((long) Integer.valueOf(RoleConstants.ADMIN.getRoleId()));
		userRoleRepo.save(userRole);

		Role role = roleRepo.findByRoleId(userRole.getRoleId());

		log.info("Assigned default role to new user");
